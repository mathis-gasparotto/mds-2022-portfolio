              ...
              <!-- <div class="page home-page">
                <div class="page-content" id="page-content">
                  ...
                  <section class="section maintenance full full--center">
                    <div class="content">
                      <h2>Cette page est en cous de construction</h2>
                      <a href="https://github.com/Mathis-Gasparotto?tab=repositories" class="btn btn-primary btn-with-icon" target="_blank">
                    ...
                    <div class="container">
                      ...
                      <div class="project-container">
                        ...
                        <div class="text-container">
                          <p class="content text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Officia tempora placeat aliquam aperiam minus minima mollitia et ratione? Tenetur laudantium possimus pariatur porro ipsam sed facilis maiores obcaecati nam culpa.</p>
          ...
          <nav class="nav-mobile bg-light">
            <ul class="nav-items">
              <li class="nav-item" id="nav-skills"><a href="#skills" class="nav-link scroll-animation">
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" viewBox="0 0 512 512" class="icon">
              ...
              <li class="nav-item" id="nav-who"><a href="#who" class="nav-link scroll-animation">
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" viewBox="0 0 511.997 511.997" xml:space="preserve" class="icon">
              ...
              <li class="nav-item" id="nav-contact"><a href="#contact" class="nav-link scroll-animation">
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" viewBox="0 0 64 64" xml:space="preserve" class="icon">
